# ═══════════════════════════════════════════════════════════
# RENAMER BOT v3.4 – FINAL WORKING (API Hardcoded)
# ═══════════════════════════════════════════════════════════
...
# ═══════════════════════════════════
API_ID = 37407868
API_HASH = "d7d3bff9f7cf9f3b111129bdbd13a065"  # <-- tera hash (test se match)
BOT_TOKEN = "8780999113:AAGf1b327eBMRSR6tSv0J0IpEtfzAP2skzk"  # <-- tera token (test se match)

# Environment se baaki config
from config import (
    OWNER_ID, DUMP_CHANNEL, DUMP_BOT_TOKENS, MAX_FILE_SIZE, OWNER_USERNAME
)
...
# ═══ RENAME HANDLER (Temp-File, Single Upload, Progress) ═══
